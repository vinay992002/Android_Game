...
public class ChatManager {
    ...
    public static final int Move_Player_Recieve =7;
    public static final int Move_Player_send = 8;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case MESSAGE_RECEIVE_IMAGE:
                    ...
                    addMessage(imageBox);
                    break;
                case Move_Player_send :
                    if(isHost) {
                        byte[] sendMove = buildPacket(Move_Player_send, senderId, sender, body);
                        writeMessage(sendMove);
                    }
                    break;
                case Move_Player_Recieve:
                    MessageBox msgBox = new MessageBox(sender, new String(body), new Date(), isSelf);
                    addMessage(msgBox);
                    break;
    ...
    public void writeMessage(byte[] byteArray, int senderId) {
        ...
        else if(type == Move_Player_send)
            receiveType = Move_Player_Recieve;

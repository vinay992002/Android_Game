...
public class bingohost extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bingobtn = new Button[25];
        bingobtn[0] = (Button) findViewById(R.id.Bt00);
        if(bingobtn[0]!=null)
            System.out.println("i was wrong");
        bingobtn[1] = (Button) findViewById(R.id.Bt01);
        bingobtn[2] = (Button) findViewById(R.id.Bt02);
        bingobtn[3] = (Button) findViewById(R.id.Bt03);
        bingobtn[4] = (Button) findViewById(R.id.Bt04);
        bingobtn[5] = (Button) findViewById(R.id.Bt10);
        bingobtn[6] = (Button) findViewById(R.id.Bt11);
        bingobtn[7] = (Button) findViewById(R.id.Bt12);
        bingobtn[8] = (Button) findViewById(R.id.Bt13);
        bingobtn[9] = (Button) findViewById(R.id.Bt14);
        bingobtn[10] = (Button) findViewById(R.id.Bt20);
        bingobtn[11] = (Button) findViewById(R.id.Bt21);
        bingobtn[12] = (Button) findViewById(R.id.Bt22);
        bingobtn[13] = (Button) findViewById(R.id.Bt23);
        bingobtn[14] = (Button) findViewById(R.id.Bt24);
        bingobtn[15] = (Button) findViewById(R.id.Bt30);
        bingobtn[16] = (Button) findViewById(R.id.Bt31);
        bingobtn[17] = (Button) findViewById(R.id.Bt32);
        bingobtn[18] = (Button) findViewById(R.id.Bt33);
        bingobtn[19] = (Button) findViewById(R.id.Bt34);
        bingobtn[20] = (Button) findViewById(R.id.Bt40);
        bingobtn[21] = (Button) findViewById(R.id.Bt41);
        bingobtn[22] = (Button) findViewById(R.id.Bt42);
        bingobtn[23] = (Button) findViewById(R.id.Bt43);
        bingobtn[24] = (Button) findViewById(R.id.Bt44);


        mChatManager = new bingoManager(this, true,bingobtn);
        for(int i=0;i<25;i++)
            bingobtn[i].setId(i);
        MyClickHandler handler = new MyClickHandler();
        for(Button b:bingobtn){
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id ==R.id.hset)
        {
            if(setup==0)
            {
                ...
                bhflg=0;
                Toast.makeText(this,"chalo khelo",Toast.LENGTH_SHORT).show();
            }
            else
            {
    ...
    public void setup(){
        if(setup==0)
        {
            ...
            {
                flag[i/5][i%5]=0;
                bingobtn[i].setText(arr.get(i)+"");
                bingobtn[i].setEnabled(true);
            }
            setup =1;
            startup =1;
        }
    ...
    public void cross(int loc){
        if(startup==1 && flag[loc/5][loc%5]==0 && bhflg==0)
        {
            byte[] byteArray;
            bhflg=1;
